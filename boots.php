  ...
  <div id="search-item"></div>
      ...
      <div class="row justify-content-center mt-5">
        <ul class="font-weight-bold">
          <li>
            <a href="index.php" id="national">National <span><img src="/Img/national.png" alt="" width="20px"></span></a>
          </li>
          <li class="ml-3" id="club">
            <a href="clubs.php" href="#">Club Teams 
              <span>
                <img src="/Img/club.png" alt="" width="20px"></span> 
              </a>
          </li>
          <li class="ml-3" id="boots">
            <a href="boots.php"  class="text-danger">Boots <span>
              <img src="/Img/boot.png" alt="" width="20px"></span>
            </a>
          </li>
      ...
      ?>
          ...
          <li class="menu pb-4 p-2 pr-5" id="boots-menu">
            <a href="boots.php" class="text-danger">Boots <span><img src="/Img/boot.png" alt="" width="20px"></span></a></li> 
            </ul>
          </div>
      ...
      >
        ...
        <div class="carousel-inner rounded">
          <div class="carousel-item active">
            <img
              src="Img/slideshow/nike-boot.jpg"
              alt="Upcoming"
              width="100%"
              height="50%"
            />
          ...
          <div class="carousel-item">
            <img
              src="Img/slideshow/adidas-boot.jpg"
              alt="Upcoming"
              width="100%"
              height="50%"
            />
          ...
          <div class="carousel-item">
            <img
              src="Img/slideshow/puma-boot.jpg"
              alt="Upcoming"
              width="100%"
              height="50%"
            />
      ...
      <h5 class="mt-5 font-weight-bold ">Here We Go Boots</h5>
      <!-- boot page -->
     ...
     data-aos-duration="2000">
          <form action="payment.php" method="POST">
            <input type="text" name="boot-name" hidden value="<?php echo$name;?>"  readonly >
            <input type="text" name="boot-price" hidden value="<?php echo$price."$";?>" readonly>
            <input type="text" name="boot-image" hidden value="<?php echo$image?>">
            <div class="shadow-lg bg-light rounded-lg">
          <img style="object-fit:fill;" src="<?php echo $image;?>" 
                alt="" width="65%" id="ma"
                class="mt-5"/>
          <p id="name-1" class="name">  <?php echo $name; ?>
          </p>
          <p class="small text-info font-weight-bold"><?php echo $description;?></p>

          <!-- <p class="name">  <?php echo $name; ?></p> -->
          
          <span
            class="p-2 text-light bg-info mr-5 font-weight-bold rounded"
            > <?php echo $price."$";
             ?>
          </span>
          ...
          <br />
            ...
            <button type="submit" name="boot-shop-btn" class="shop-btn btn btn-outline-danger ml-2 mt-4 rounded-pill shop-btn" 
            >Shop Now</button>
