  ...
  <div class="container fw-semibold">
    <div class="hero row justify-content-between py-5">
      <div class="col-lg-3 col-md-3 col-6">
        <p class="fs-5">National Team Kits</p>
      </div>
      <div class="col-lg-3 col-md-3 col-6">
    ...
    <div id="demo" class="carousel slide text-center shadow-lg rounded" data-ride="carousel">
      ...
      <div class="carousel-inner rounded">
        ...
        <div class="carousel-item">
          <img src="Img/slideshow/bra.jpg" alt="advert" width="100%" height="50%" />
        </div>
        <div class="carousel-item">
          <img src="Img/slideshow/por.jpg" alt="advert" width="100%" height="50%" />
        </div>
        <div class="carousel-item">
          <img src="Img/slideshow/colo.jpg" alt="advert" width="100%" height="50%" />
        </div>
        <div class="carousel-item">
          <img src="Img/slideshow/eng.jpg" alt="advert" width="100%" height="50%" />
        </div>
        <div class="carousel-item">
          <img src="Img/slideshow/aut.jpg" alt="advert" width="100%" height="50%" />
        </div>
        <div class="carousel-item">
          <img src="Img/slideshow/fra.jpg" alt="advert" width="100%" height="50%" />
        </div>
      </div>
    ...
    <div class="my-5">
      <h5 class="py-5">Here We Go National Kits</h5>
      <p>We have a wide selection of kits to choose from, so you can find the perfect one to show your support for your
        country. We also offer a wide variety of sizes and styles, so you can find the perfect kit for your needs.
        Whether you're a young child or a grown adult, we have a kit for you.</p>
    </div>

    <!-- nation page -->
    <div id="nation-page" class="row text-center mt-5 pt-5">
      <?php
      while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        <div class="col-lg-3 col-md-4 col-6 mb-5" data-aos="fade-up" data-aos-duration="2000">
          <form action="product-detail.php" method="POST">
            ...
            <div class="product-container shadow-lg bg background">
    ...
    <ul class='pagination justify-content-center m-5'>
      ...
      for ($i = 1; $i <= $pageItem; $i++) {
        ...
        echo "<li class ='page-item'> <a class='page$i page-link btn' href='index.php?page=" . $i . "'>" . $i . "</a></li>";
      }
      ?>
    </ul>
    </ul>
