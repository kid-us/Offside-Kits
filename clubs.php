...
include("Php/conn.php");
    ...
    $sql = "SELECT * FROM clubs ORDER BY id DESC LIMIT $start_from, $pageNum";
  ...
  <body>
    ...
    <div class="container font-weight-bold">
      ...
      <div class="d-none d-md-block">
        ...
        <ul class="m-4">
          <li class="Navs"><a href="index.php"> <span class="mr-3"><img src="/Img/logo.png" alt="" width="150px"></span></a></li>
        ...
        <div  id="accounts-page" class="row justify-content-center hidden">
          <div style="position:absolute; z-index: 1;" class="offset-md-7 offset-lg-8 offset-xl-8 col-md-2 col-lg-2 col-xl-2 shadow-lg bg-light rounded p-3">
            ...
            <!-- DASHBOARD MODAL -->
            <div class="row">
              <div style="position:absolute; z-index: 1;" id="dashboard" class="w-25 bg-light offset-8 col-2 shadow-lg rounded hidden pt-3">
        ...
        <!-- other device not in small device search result container -->
              <div class="row justify-content-center mt-5">
                <ul class="font-weight-bold">
                  <li>
                    <a href="index.php" id="national">National
                      <span>
                  ...
                  <li class="ml-3" id="club">
                    <a href="clubs.php" href="#"  class="text-danger" >Club Teams 
                      <span>
                        <img src="/Img/club.png" alt="" width="20px">
                      </span> 
                    </a>
                  </li>
                  <li class="ml-3" id="boots">
                    <a href="boots.php">Boots 
                      <span>
                        <img src="/Img/boot.png" alt="" width="20px">
                      </span>
                    </a>
                  </li>
                  <a href="cart.php" id="show"  title="Cart">
        ...
        <div id="menu-page" class="shadow-lg rounded hidden">
          <ul class="font-weight-bold">
            ...
            <li class="menu pt-4 p-2 pr-5">
              <a href="index.php" class="" id="national-menu">National  <span><img src="/Img/national.png" alt="" width="20px"></span></a>
            </li>

            <li class="menu p-2 pr-5" id="club-menu">
              <a href="clubs.php" class="text-danger">Club Teams  <span><img src="/Img/club.png" alt="" width="20px"></span></a>
            </li >

            <li class="menu pb-4 p-2 pr-5" id="boots-menu">
              <a href="boots.php">Boots <span><img src="/Img/boot.png" alt="" width="20px"></span></a>
            </li> 

            <a href="#" id="show" class="hidden" title="Cart">
              <img src="Img/side cart.png" alt="" width="28px" class="ml-4" />
                <span
                  id="badge-counter"
                  class="badge bg-danger text-light rounded-circle"
      ...
      <!-- Small device end -->
            ...
            <!-- Carousel -->
            <h5><span class=" rounded font-weight-bold">Upcoming kits. . . </span> <span><img src="Img/soon.png" alt="available icon" width="4%"></span></h5>
        <div
          id="demo"
...
<!-- Club page -->
      <h5 class="mt-5"><span class="font-weight-bold">Available Kits</span> <span><img src="Img/available.png" alt="available icon" width="4%"></span></h5>
      <div id="club-page" class="row text-center mt-5">
      <?php
     ...
     data-aos-duration="2000">
          <form action="payment.php" method="POST">
            <input type="text" name="club-item-name" hidden value="<?php echo$name;?>"  readonly >
            <input type="text" name="club-item-price" hidden value="<?php echo$price."$";?>" readonly>
            <input type="text" name="club-image" hidden value="<?php echo$image?>">
            
            <div class="shadow-lg bg-light rounded-lg">
            <img src="<?php echo $image;?>" alt="" width="65%" class="mt-5" />
            ...
            <br />
            <button type="submit" name="club-shop-btn" class="shop-btn btn btn-outline-danger ml-2 mt-4 rounded-pill">Shop Now</button>
            <br />
            <br />
      </div>
          </form>
      ...
      <ul class='pagination justify-content-center m-5 text-dark'>
          ...
          for($i =1; $i <= $pageItem; $i++){
            ...
            echo "<li class = 'page-item'> <a id='page' class='page$i page-link btn ' href='clubs.php?page=".$i."'>".$i."</a></li>" ;
          }
        ?>
      </ul>
