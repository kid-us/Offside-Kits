  ...
  <div class="container fw-semibold">
    ...
    <div class="hero row justify-content-between py-5">
      <div class="col-lg-3 col-md-3 col-6">
        <p class="fs-5">Clubs Team Kits</p>
      </div>
      <div class="col-lg-3 col-md-3 col-6">
    ...
    <div id="demo" class="carousel slide text-center shadow-lg rounded" data-ride="carousel">
      ...
      <div class="carousel-inner rounded">
        ...
        <div class="carousel-item">
          <img src="Img/slideshow/real.jpg" alt="advert" width="100%" height="50%" />
        </div>
        <div class="carousel-item">
          <img src="Img/slideshow/liverpool.jpg" alt="advert" width="90%" height="50%" />
        </div>
        <div class="carousel-item">
          <img src="Img/slideshow/juve.jpg" alt="advert" width="90%" height="50%" />
        </div>
        <div class="carousel-item">
          <img src="Img/slideshow/mun.jpg" alt="advert" width="90%" height="50%" />
        </div>
      </div>
    ...
    <!-- Club page -->
    <div class="my-5">
      <h5 class="py-5">Here We Go Club Kits</h5>
      <p>We have a wide selection of kits to choose from, so you can find the perfect one to show your support for your
        club. We also offer a wide variety of sizes and styles, so you can find the perfect kit for your needs. Whether
        you're a young child or a grown adult, we have a kit for you.</p>
    </div>
    ...
    <p id="page-number" data-page="<?php echo $page; ?>"></p>
    <ul class='pagination justify-content-center m-5 text-dark'>
      <?php
      for ($i = 1; $i <= $pageItem; $i++) {
        echo "<li class ='page-item'> 
                  <a id='page' class='page$i page-link btn' href='clubs.php?page=" . $i . "'>" . $i . "</a>
                </li>";
      }
      ?>
    </ul>
